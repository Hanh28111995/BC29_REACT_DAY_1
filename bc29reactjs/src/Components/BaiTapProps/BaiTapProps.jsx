...
import BaiTapThuDo from '../Redux/baiTapThiDo/BaiTapThuDo'
  ...
  render() {
    return (
        ...
        <div className="col-9">
            ...
            <div className="tab-pane w3-animate-right	 fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab"><BaiTapModal /></div>
            <div className="tab-pane w3-animate-right	 fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab"><BaiTapDienThoai /></div>
            </div>
        </div>
        </div>
